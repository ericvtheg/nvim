...
vim.keymap.set('t', '<leader>tt', '<C-\\><C-n>:lua ToggleTerminal()<CR>',
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', function()
        builtin.live_grep {
          additional_args = { '--glob', '!package-lock.json' },
        }
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'vim', 'vimdoc', 'yaml' },
